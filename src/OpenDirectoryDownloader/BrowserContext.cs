...
namespace OpenDirectoryDownloader
{
    public class BrowserContext
    {
        ...
        private void Page_Response(object sender, ResponseCreatedEventArgs e)
        {
            ...
            {
                CookieContainer.SetCookies(new Uri(e.Response.Url), e.Response.Headers["set-cookie"]);
                Cookie cloudflareClearance = CookieContainer.GetCookies(new Uri(e.Response.Url)).FirstOrDefault(c => c.Name == CloudflareClearanceKey);
